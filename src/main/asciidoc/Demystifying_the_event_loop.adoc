...
This feature is deprecated since Vert.x 3.6 and will be removed in Vert.x 4. This feature is often confusing for
the user  and it is possible to achieve the same concurrency with an event-loop context and `executeBlocking` with
