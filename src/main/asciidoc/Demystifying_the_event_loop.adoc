...
todo : talk about the new `link:../../apidocs/io/vertx/core/Context.html#isEventLoopContext--[isEventLoopContext]` ()}, `link:../../apidocs/io/vertx/core/Context.html#isOnEventLoopThread--[Context.isOnEventLoopThread]` ()}, etc...
